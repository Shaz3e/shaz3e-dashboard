...
<div wire:ignore.self id="updateModal" class="modal fade" tabindex="-1" aria-labelledby="#updateModalLabel" style="display: none;"
    aria-hidden="true">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            <form wire:submit="update">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateModalLabel">Fullscreen Modal</h5>
